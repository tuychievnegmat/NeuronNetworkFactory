...
public class View extends JPanel {
    ...
    public View(Tile[][] gameTiles, String ch, String queryResult) {
        setFocusable(true);
    ...
    public void paint(Graphics g) {
        ...
        for (int x = 0; x < GameTiles.length; x++) {
            for (int y = 0; y < GameTiles[0].length; y++) {
                drawTile(g, GameTiles[y][x], x, y);
            }
        }
        g.drawString("real result: " + ch, 650, 650);
        g.drawString("query result: " + queryResult, 650, 750);
